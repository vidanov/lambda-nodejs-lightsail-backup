...
exports.handler = (event, context, callback) => {
  ...
  const backupDaysMax = process.env['days']; // keep at least 7 daily backups 
  const backupWeeksMax = process.env['weeks']; // keep at least 4  weekly  backups
  const backupMonthsMax = process.env['months']; // keep at least 3  monthly  backups

  // ================================        
  // Unique short tag for snapshots
  // ================================

  const labelTag = process.env['labelTag']+"_";
